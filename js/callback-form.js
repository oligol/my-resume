...
const requestRiceivedModal = document.querySelector('#request-received');
...
callbackForm.addEventListener('submit', function (event) {
    ...
    requestRiceivedModal.classList.add('modal-active');
    setTimeout(function () {
        requestRiceivedModal.classList.remove('modal-active');
    }, 2000); 
